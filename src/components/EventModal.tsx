...
export default function EventModal({
    ...
    const updateSchedule = (
        field: keyof NonNullable<Event['schedule']>,
        value: any,
    ) => {
        setForm((prev) =>
            prev
    ...
    const updatePricing = (
        field: keyof NonNullable<Event['pricing']>,
        value: any,
    ) => {
        setForm((prev) =>
            prev
    ...
    const updateImages = (
        field: keyof NonNullable<Event['images']>,
        value: any,
    ) => {
        setForm((prev) =>
            prev
                    ...
                    {mode === 'view' ? (
                        ...
                        <form className="space-y-3">
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    updateImages('banner', e.target.value)
                                }
                                className="border px-2 py-1 w-full"
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    updateImages('thumbnail', e.target.value)
                                }
                                className="border px-2 py-1 w-full"
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    updateImages('gallery', e.target.value)
                                }
                                className="border px-2 py-1 w-full"
