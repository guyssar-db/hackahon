...
export default function PopularEvents({ events }: Props) {
  if (!events.length) return <p className="text-center py-10 dark:text-white">Loading popular events...</p>

  return (
    <section className="flex flex-col justify-center w-[86%] p-4 mb-10 pt-10">
